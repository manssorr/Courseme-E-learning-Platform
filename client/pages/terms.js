      ...
      <div className="container ">
        <div>
          ...
          <h5>
            ...
            to Courseme. Courseme is committed to ensuring that the app is as
            ...
            paying for. The Courseme app stores and processes personal data that
            ...
            mean that the Courseme app won’t work properly or at all. The app
            does use third-party services that declare their Terms and
            Conditions. Link to Terms and Conditions of third-party service
            providers used by the app Google Play Services You should be aware
            that there are certain things that Courseme will not take
            ...
            Wi-Fi or provided by your mobile network provider, but Courseme
            cannot take responsibility for the app not working at full
            functionality if you don’t have access to Wi-Fi, and you don’t have
            any of your data allowance left. If you’re using the app outside of
            an area with Wi-Fi, you should remember that the terms of the
            ...
            data for the duration of the connection while accessing the app, or
            ...
            for using the app. Along the same lines, Courseme cannot always take
            ...
            you can’t turn it on to avail the Service, Courseme cannot accept
            responsibility. With respect to Courseme’s responsibility for your
            ...
            information to us so that we can make it available to you. Courseme
            ...
            the app. At some point, we may wish to update the app. The app is
            currently available on – the requirements for the system(and for any
            ...
            to keep using the app. Courseme does not promise that it will always
            ...
            using the app, and (if needed) delete it from your device. Changes
            to This Terms and Conditions We may update our Terms and Conditions
            ...
            conditions are effective as of 2022-06-23 Contact Us If you have any
            questions or suggestions about our Terms and Conditions, do not
            hesitate to contact us at mecourse8@gmail.com.
          </h5>
        </div>
      </div>
      <div className="container">
